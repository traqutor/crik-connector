      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return _context11.abrupt('return', (0, _superagent2.default)(method, route).set({ Authorization: 'Bearer ' + options.apiToken }).set({ 'content-type': 'application/json' }).send(params));
