...
var getResourceById = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(options, id) {
    var token, route, method, response;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            method = 'GET';
            _context2.next = 7;
            return (0, _superagent2.default)(method, route).set({ Authorization: 'Bearer ' + token });

          case 7:
            response = _context2.sent;

            console.log('response', response);
            return _context2.abrupt('return', (0, _common.normalizeResource)(response.body.response));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            method = 'GET';
            _context3.next = 5;
            return (0, _superagent2.default)(method, route).set({ Authorization: 'Bearer ' + options.apiToken });

          case 5:
            response = _context3.sent;
            return _context3.abrupt('return', response.body.response.items.map(_common.normalizeResource));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 4;
            return _superagent2.default.get(route).set({ Authorization: 'Bearer ' + options.apiToken });
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            return _context9.abrupt('return', _superagent2.default.post(route).set({ Authorization: 'Bearer ' + apiOptions.apiToken }).field('type', 'file').field('parentId', parentId).attach('files', file.file, file.name).on('progress', function (event) {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _context10.next = 3;
            return _superagent2.default.get(downloadUrl).set({ Authorization: 'Bearer ' + apiOptions.apiToken }).responseType('blob').on('progress', function (event) {
              onProgress(event.percent);
            });
...
var createFolder = function () {
  var _ref14 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(options, parentId, folderName) {
    var route, method, params, formData;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return _context11.abrupt('return', (0, _superagent2.default)(method, route).set({ Authorization: 'Bearer ' + options.apiToken }).send(formData));
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            ...
            route = options.apiRoot + '/files/' + id;
            method = 'PATCH';
            return _context12.abrupt('return', (0, _superagent2.default)(method, route).set({ Authorization: 'Bearer ' + options.apiToken }).type('application/json').send({ name: newName }));
...
var changeDirectory = function () {
  var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(options, guid, destination) {
    var route, method, response;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            route = options.apiRoot + '/files/' + guid;
            method = 'PATCH';
            _context13.next = 5;
            return (0, _superagent2.default)(method, route).set({ Authorization: 'Bearer ' + options.apiToken }).type('application/json').send({ parents: [destination] });

          case 5:
            response = _context13.sent;
            return _context13.abrupt('return', getResourceById(options, response.response.parentId));
  ...
  return function changeDirectory(_x26, _x27, _x28) {
...
var removeResource = function () {
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            method = 'DELETE';
            return _context14.abrupt('return', (0, _superagent2.default)(method, route).set({ Authorization: 'Bearer ' + options.apiToken }));
  ...
  return function removeResource(_x29, _x30) {
...
var removeResources = function () {
  ...
  return function removeResources(_x31, _x32) {
